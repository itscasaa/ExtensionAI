...
const MoodleAutoSolve = (props: MoodleAutoSolveProps) => {
    ...
    function displayStealthAnswer(question: Question, answer: Answer) {
        ...
        const formulation = props.questionElement.querySelector(".formulation");
        if (formulation) {
            const existingBox = formulation.querySelector(".stealth-answer-box");
            if (existingBox) {
                existingBox.remove();
            }
            ...
            formulation.appendChild(answerBox);
        }
    }
